...
export const RegistryPage: React.FC<RegistryPageProps> = ({ projects, onSelectProject, onCreateNew }) => {
  return (
            ...
            <table className="w-full text-sm text-left">
              ...
              <tbody>
                {projects.map((project) => (
                  <tr key={project.id} className="border-b border-border hover:bg-secondary/50 cursor-pointer" onClick={() => onSelectProject(project.id)}>
